...
public class CollisionManager extends ComponentManager<Collidable> implements
		ActionListener {
	final static Logger logger = LoggerFactory
			.getLogger(CollisionManager.class);

	@Override
	public void processComponents() {
		for (Collidable collidable : getComponents()) {
			List<Collidable> otherCollidables = new LinkedList<Collidable>(
					getComponents());
